        ...
        <form method="POST" action="{{ route('customer.update', $Customer['id']) }}">
            ...
            <fieldset>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input id="name" name="name" type="text" placeholder="Tom Cruise" class="form-control input-md" value="{{old('name', $Customer['name'])}}">
                        @if($errors->has('name'))
                            <div>
                ...
                <div class="form-group row  text-right">
                    ...
                    <div class="col-md-4">
                        <input id="email" name="email" type="text" placeholder="thisisavalidemail at gmail.com " class="form-control input-md" value="{{old('email', $Customer['email'])}}">
                        @if($errors->has('email'))
                            <div>
                ...
                <div class="form-group row  text-right">
                    ...
                    <div class="col-md-4">
                        <input id="password" name="password" type="password" placeholder="" class="form-control input-md" value="{{ $Customer['password'] }}">
                ...
                <div class="form-group row  text-right">
                    ...
                    <div class="col-md-4">
                        <input id="confirmPassword" name="confirmPassword" type="password" placeholder="" class="form-control input-md" value="{{ $Customer['password'] }}">
